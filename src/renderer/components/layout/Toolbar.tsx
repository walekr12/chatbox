...
export default function Toolbar({ sessionId }: { sessionId: string }) {
  ...
  const setTimelineDrawerOpen = useSetAtom(atoms.showTimelineDrawerAtom)
  ...
  return !isSmallScreen ? (
    <Flex align="center" gap="md" className="controls">
      ...
      <ActionIcon variant="subtle" size={28} color="chatbox-secondary" onClick={() => setTimelineDrawerOpen(true)}>
        <ScalableIcon icon={IconGitBranch} size={20} strokeWidth={1.8} />
      </ActionIcon>
